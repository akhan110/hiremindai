...
class _CandidateCardState extends State<CandidateCard> {
  ...
  Color get _matchColor {
    switch (widget.candidate.matchLabel) {
      case 'STRONG MATCH':
  ...
  Color get _scoreColor {
    final s = widget.candidate.matchScore;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // AI Summary (always visible for first card, collapsible for others)
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        ...c.interviewQuestions.asMap().entries.map(
                              (e) => Padding(
                                padding:
          ...
          // Expand / Collapse toggle for non-first cards
          if (widget.index != 0)
            InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      _expanded ? 'Hide AI Analysis' : 'View AI Analysis',
                      style: GoogleFonts.inter(
                        fontSize: 12,
                        fontWeight: FontWeight.w600,
                        color: const Color(0xFF1A56DB),
    ...
    ).animate().fadeIn(delay: (widget.index * 100).ms).slideY(begin: 0.05);
  }
}
